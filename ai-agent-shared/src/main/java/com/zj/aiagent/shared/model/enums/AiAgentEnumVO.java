package com.zj.aiagent.shared.model.enums;
...
public enum AiAgentEnumVO {
    ...
    AI_API("对话API", "api", "ai_api_", "ai_api_data_list", "aiClientApiLoadDataStrategy"),
    AI_MODEL("对话模型", "model", "ai_model_", "ai_model_data_list", "aiClientModelLoadDataStrategy"),
    AI_SYSTEM_PROMPT("提示词", "prompt", "ai_system_prompt_", "ai_system_prompt_data_list", "aiClientSystemPromptLoadDataStrategy"),
    AI_TOOL_MCP("mcp工具", "tool_mcp", "ai_tool_mcp_", "ai_tool_mcp_data_list", "aiClientToolMCPLoadDataStrategy"),
    AI_ADVISOR("顾问角色", "advisor", "ai_advisor_", "ai_advisor_data_list", "aiClientAdvisorLoadDataStrategy"),
