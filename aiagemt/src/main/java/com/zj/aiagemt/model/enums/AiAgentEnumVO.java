...
public enum AiAgentEnumVO {
    ...
    AI_TOOL_MCP("mcp工具", "tool_mcp", "ai_tool_mcp_", "ai_client_tool_mcp_data_list", "aiClientToolMCPLoadDataStrategy"),
    AI_ADVISOR("顾问角色", "advisor", "ai_advisor_", "ai_client_advisor_data_list", "aiClientAdvisorLoadDataStrategy"),
