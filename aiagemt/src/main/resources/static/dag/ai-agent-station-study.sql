...
DROP DATABASE IF EXISTS `ai_agent_station_study`;
CREATE DATABASE `ai_agent_station_study` CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;

USE `ai_agent_station_study`;
...
CREATE TABLE `ai_agent`  (
                             ...
                             PRIMARY KEY (`id`) USING BTREE,
                             UNIQUE INDEX `uk_agent_id_user_id`(`agent_id` ASC, user_id) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI智能体配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '智能体任务调度配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '顾问配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'OpenAI API配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_model`  (
                                    ...
                                    INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '聊天模型配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '系统提示词配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'MCP客户端配置表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI节点模版配置表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ai_agent_instance`  (
                                         ...
                                         `version_id` bigint NOT NULL COMMENT '关联的工作流版本ID',
                                         ...
                                         INDEX `idx_status`(`status` ASC) USING BTREE
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI工作流运行实例表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB  CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'AI智能体执行日志表' ROW_FORMAT = Dynamic;
