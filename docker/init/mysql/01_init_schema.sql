...
('HTTP', 'HTTP请求节点', '发起HTTP请求调用外部API', 'globe',
 '{"inputSchemaAdd": true, "outputSchemaAdd": true, "inputSchemaUpdate": true, "outputSchemaUpdate": true}',
 '{"inputSchema": [], "outputSchema": [{"key": "http_response", "type": "object", "label": "HTTP 响应", "system": true, "description": "HTTP 响应的完整内容"}]}',
 'ACTION', 40, 1),
...
CREATE TABLE IF NOT EXISTS `writing_task` (
  ...
  `status` varchar(20) DEFAULT 'PENDING' COMMENT '任务状态: PENDING/PLANNED/ASSIGNED/RUNNING/DONE/FAILED/CANCELLED',
